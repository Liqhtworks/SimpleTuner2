...
usage: train.py [-h] [--snr_gamma SNR_GAMMA] [--use_soft_min_snr]
                ...
                [--flux_lora_target {mmdit,context,context+ffs,all,all+ffs,ai-toolkit,tiny,nano,dsy-kontext,dsy-flux,controlnet,all+ffs+embedder,all+ffs+embedder+controlnet}]
